...
Dudo.Interfaz = (function () {
  ...
  // Crea un ícono de flecha (triángulo dibujado con CSS) para los
  // botones de sumar/restar dados propios. Su color (verde o rojo)
  // y grosor se definen íntegramente en styles.css
  function crearIconoFlecha(direccion) {
    var icono = document.createElement("span");
    icono.className = "arrow-icon small " + direccion;
  ...
  function buildMyDiceGrid() {
    ...
    for (var f = 1; f <= 6; f++) {
      ...
      botonSubir.className = "mini-btn up";
      ...
      botonBajar.className = "mini-btn down";
  ...
  function alternarModoOscuro() {
    ...
    var activo = document.body.classList.contains("dark-mode");
...
Dudo.Interfaz = (function () {
  ...
  function buildResponsesGrid() {
    ...
    for (var f = 1; f <= 6; f++) {
      ...
      var etiquetaSin = document.createElement("div");
      etiquetaSin.className = "prob-label";
      etiquetaSin.textContent = "Sin";

      var probSin = document.createElement("div");
      probSin.className = "prob-row";
      probSin.id = "resp-sin-" + f;

      var etiquetaCon = document.createElement("div");
      etiquetaCon.className = "prob-label";
      etiquetaCon.textContent = "Con";
      ...
      celda.appendChild(botonCantidad);
      celda.appendChild(icono);
      celda.appendChild(etiquetaSin);
      celda.appendChild(probSin);
      celda.appendChild(etiquetaCon);
      celda.appendChild(probCon);
      contenedor.appendChild(celda);
    }
  }
